...
import classes from './validemail.module.css'
...
const PlacementScore = (props) => {
   ...
   const scroll = (key,props) => {
    ...
    return(
        <div className = {classes.parent} id = "email">
            <div className = {classes.firstChild}>
                <h3>ایمیل خود را وارد کنید </h3>
                <div className = {classes.input}>
                <Input size="large" placeholder="email" prefix={<UserOutlined />} onChange={changeHandler}/>
                </div>
            </div>
